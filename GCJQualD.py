# Jacob Madrid - submission for Google Code Jam 2014 Qualification Round
# Problem Spec: https://code.google.com/codejam/contest/2974486/dashboard#s=p3
...
outfile = open('D-small-attempt1.txt', 'w')
